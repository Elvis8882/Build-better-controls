-- Restore SECURITY DEFINER for bracket/group generators after 2v2 refactor,
-- fix placement final assignment ordering, and widen bottom tier to last 10 teams.

alter function public.generate_group_stage(uuid) security definer;
alter function public.generate_group_stage(uuid) set search_path = public;
